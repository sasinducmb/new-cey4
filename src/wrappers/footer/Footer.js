          ...
          <div className="col-md-6">
            <div className="mb-4">
              <button className="btn btn-light rounded-pill px-4">
                <span className="text-success fw-bold">Cey4Hub</span>
              </button>
            </div>
            ...
            <div className="mb-3 d-flex gap-3">
              <a href="https://web.facebook.com/profile.php?id=61569993566020" className="text-white">
                <svg
              ...
              <a href="https://www.tiktok.com/@cey4hub" className="text-white">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
              ...
              <a href="https://www.instagram.com/cey4hub/" className="text-white">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
            ...
            <div className="small mt-2">Ceyhub © all right reserved 2025</div>
          </div>
