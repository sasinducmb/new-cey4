...
function Services() {
  return (
    <div className="container my-5">
      <h2 className="text-center mb-5 service-header">Why Choose Cey4Hub</h2>
      <div className="row">
        ...
        <div className="col-md-3 text-center">
          ...
          <h5 className="services-header mt-2 mb-4">Sustainable Products</h5>
        ...
        <div className="col-md-3 text-center">
          ...
          <h5 className="services-header mt-2 mb-4">Eco-Friendly Choices</h5>
          <p className="services">
        ...
        <div className="col-md-3 text-center">
          ...
          <h5 className="services-header mt-2 mb-4">High-Quality Selection</h5>
          <p className="services">
        ...
        <div className="col-md-3 text-center">
          ...
          <h5 className="mt-2 services-header mb-4">Sustainable Packaging</h5>
          <p className="services">
